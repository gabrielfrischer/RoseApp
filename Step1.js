...
import StopWatch from "./StopWatchStep1";
...
{
  this.state.fontLoaded ? (
    <Text style={{ fontFamily: 'comfortaaBold', fontSize: 16, color:'white', textAlign:"center" }}>
...
<Row style={{height:Dimensions.get('window').height/3}}>
  <StopWatch/>
  </Row>
