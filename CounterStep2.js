  ...
  render() {
    ...
    return (
      <View style={styles.centerIt}>
        ...
        <View>
              <Button large rounded bordered primary onPress={ () => this._incrementCount() }><Text> Count Step </Text></Button>
              <View style={{height:50}}></View>
              <Button style={styles.centerButton} block rounded small bordered danger onPress={ () => this._decrementCount() }><Text> Subtract Step </Text></Button>
